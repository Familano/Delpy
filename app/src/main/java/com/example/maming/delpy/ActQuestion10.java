...
public class ActQuestion10 extends AppCompatActivity {
    ...
    private String id_pertanyaan="Q10";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup = (RadioGroup) findViewById(R.id.AQuest9_RadioGroup);
    }
    ...
    public void onRadioButton(View view) {
        ...
        switch (view.getId()) {
            case R.id.AQuest10_RadioButtonAns0:
                if (checked)
                    score="0";
                break;
            case R.id.AQuest10_RadioButtonAns1:
                if (checked)
                    score="1";
                break;
            case R.id.AQuest10_RadioButtonAns2:
                if (checked)
                    score="2";
                break;
            case R.id.AQuest10_RadioButtonAns3:
                if (checked)
                    score="3";
                break;
        }
